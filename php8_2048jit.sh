...
sudo echo 'opcache.jit_buffer_size=2048M' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.jit=1255' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.memory_consumption=2048' >> /etc/php/8.0/fpm/php.ini
