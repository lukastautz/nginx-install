...
sudo echo 'session.gc_maxlifetime = 1440' >> /etc/php/8.1/fpm/php.ini
...
sudo mkdir /var/sitemngr/cron
sudo mkdir /var/sitemngr/cron/bash
sudo echo '# Copyright (C) 2022 Lukas Tautz' >> /var/sitemngr/cron/cronjobs
sudo echo '# DO NOT EDIT THIS FILE!' >> /var/sitemngr/cron/cronjobs
sudo crontab -u root /var/sitemngr/cron/cronjobs
