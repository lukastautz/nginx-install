...
sudo apt install -y php8.0-bcmath php8.0-bz2 php8.0-common php8.0-curl php8.0-dba php8.0-dev php8.0-enchant php8.0-fpm php8.0-gd php8.0-gmp php8.0-imap php8.0-interbase php8.0-intl php8.0-ldap php8.0-mbstring
...
sudo echo 'opcache.jit_buffer_size=1M' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.jit=Off' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.memory_consumption=1' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.interned_strings_buffer=1' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.max_accelerated_files=100' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.use_cwd=0' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.validate_timestamps=0' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.revalidate_freq=0' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.revalidate_path=0' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.save_comments=0' >> /etc/php/8.0/fpm/php.ini
sudo echo 'opcache.record_warnings=0' >> /etc/php/8.0/fpm/php.ini
